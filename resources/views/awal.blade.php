            ...
            <div
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="font-weight:bold;font-size:18px;color:rgb(0,0,0);margin-left:130px;">Akun</a>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item disabled" role="presentation" href="login.html" style="color:rgb(0,0,0);">LogIn</a><a class="dropdown-item" role="presentation" href="signUp.html" style="color:rgb(8,8,8);">SignUp</a></div>
                    </li>
                </ul>
        </div>
        </div>
