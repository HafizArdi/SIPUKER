    ...
    <div class="container"><a class="navbar-brand" href="#" style="/*margin-left:50px;*/"><img src="assets/img/logo/logo.png" style="width:70px;margin-left:100px;"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="font-weight:bold;font-size:18px;color:rgb(0,0,0);margin-left:130px;">Akun</a>
          <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="/login" style="color:rgb(0,0,0);">LogIn</a><a class="dropdown-item" role="presentation" href="#" style="color:rgb(0,0,0);">SignUp</a></div>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container">
  <div class="modal fade" role="dialog" tabindex="-1" id="modal1">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <form action="/register" method="get" id="contactForm"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.mywebsite.com"><input class="form-control" type="hidden" name="subject" value="My Contact Form"><input class="form-control" type="hidden"
              ...
              <div class="form-row">
                <div class="col-md-6" id="modal-message">
                  ...
                  <div class="form-group"><input class="btn btn-primary btn-block" type="submit">Send <i class="fa fa-chevron-circle-right"></i></input></div>
                  <hr>
                </div>
                <div class="col-md-6">
                  <fieldset>
    ...
    <form action="/register" method="post" id="contactForm"><input class="form-control" type="hidden" name="Introduction" value="This email was sent from www.mywebsite.com"><input class="form-control" type="hidden" name="subject" value="My Contact Form"><input class="form-control" type="hidden" name="to"
      ...
      <div class="form-row">
        <div class="col-md-6" id="message">
          ...
          <div class="form-group has-feedback" style="width:460px;"><label for="from_name">Nama Lengkap</label><input class="form-control" type="text" name="name" required="" placeholder="Nama Lengkap" id="from_name" tabindex="-1"></div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_email">Tempat Lahir</label><input class="form-control" type="text" name="tempat_lahir" required="" placeholder="Tempat Lahir" id="tempat_lahir"></div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_email">Tanggal Lahir</label><input class="form-control" type="date" name="tanggal_lahir" required="" placeholder="Tanggal Lahir" id="tanggal_lahir"></div>
          <div class="form-group" style="width:460px;"><label for="calltime">Jenis Kelamin</label>
            <select class="form-control" name="jenis_kelamin" id="calltime">
              <option>Pilih</option>
              <option value="Laki-Laki">Laki-Laki</option>
              <option value="Perempuan">Perempuan</option>
            </select>
          </div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Alamat</label><input class="form-control" type="text" name="alamat" placeholder="Alamat" id="from_phone"></div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Email</label><input class="form-control" type="email" name="email" placeholder="Email" id="from_phone"></div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Password</label><input class="form-control" type="password" name="password" placeholder="Password" id="from_phone"></div>
          <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">No. Telpon</label><input class="form-control" type="text" name="no_telepon" placeholder="No Telpon" id="from_phone"></div>
          <div class="form-group"><input class="btn btn-primary btn-block" type="submit">Send <i class="fa fa-chevron-circle-right"></i></input></div>
          <hr>
        </div>
        <div class="col-md-6">
          <fieldset style="margin-left:50px;">
            <legend>Data UMKM</legend>
          </fieldset>
          <div class="form-row" style="margin-left:50px;">
            <div class="col">
              <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Nama UMKM</label><input class="form-control" type="text" name="nama_ukm" placeholder="Nama UMKM" id="from_phone"></div>
            </div>
            <div class="col">
              <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Jenis UMKM</label><input class="form-control" type="text" name="jenis_ukm" placeholder="Jenis UMKM" id="from_phone"></div>
            </div>
            <div class="col">
              <div class="form-group has-feedback" style="width:460px;"><label for="from_phone">Alamat UMKM</label><input class="form-control" type="text" name="alamat_ukm" placeholder="Alamat UMKM" id="from_phone"></div>
            </div>
          </div>
        </div>
      </div>
